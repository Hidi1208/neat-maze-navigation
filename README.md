...
This work was submitted to IEEE TENCON 2025. The paper documents three formal failure modes: structural filtering and weight signal cancellation in Method A, and fitness dilution in Method B.

## Authors

- Aniruddha Deshmukh — VIT Vellore
- Siddharth Brahmankar — VIT Vellore
- Ashwin Vinod — VIT Vellore
